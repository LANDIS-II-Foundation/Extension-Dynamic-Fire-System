...
#define ExtensionName "Dynamic Fire System"
...
AppId={{CB1407CC-81EF-41B8-A48E-AF6701700DDA}
...
Source: {#BuildDir}\Landis.Extension.DynamicFire-v3.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Dynamic Fire Component 3.0.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Dynamic Fire System"" "; WorkingDir: {#LandisPlugInDir}
